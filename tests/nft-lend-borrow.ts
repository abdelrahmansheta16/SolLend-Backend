...
describe("nft-lend-borrow", () => {
    ...
    it("Can initialize the state of the world", async () => {
        ...
        let [collectionPoolAddress, _collectionBump] =
            anchor.web3.PublicKey.findProgramAddressSync(
                [
                    ...
                    assetPoolAuthority.publicKey.toBuffer()
                ],
                program.programId
            );
        ...
        console.log("Collection Pool PDA:", collectionPoolPDA.toBase58());
    ...
    it("Can create pool", async () => {
        const poolName = "TestPool"; // New: Add a pool name

        await program.methods
            .createPool(collectionId, poolName, new anchor.BN(loanDuration))
            .accounts({
        ...
        assert.strictEqual(createdPool.poolName, poolName); // New: Check pool name
    });
    ...
    it("Can offer loan", async () => {
        ...
        totalOffers = createdPool.totalOffers.toNumber();
        ...
        let [offer, _offerBump] = anchor.web3.PublicKey.findProgramAddressSync(
            [
                ...
                createdPool.totalOffers.toBuffer('le', 8),
            ],
            program.programId
        );
        offerPDA = offer;
    ...
    it("Can offer second loan", async () => {
        ...
        await program.methods
            .offerLoan(offerAmount) // New: Include poolName
            .accounts({
                offerLoan: offerPDA,
                vaultAccount: vaultPDA,
                collectionPool: collectionPoolPDA,
